...
class TestRemoveAccents(unittest.TestCase):
    ...
    def test_single_lowercase_translate(self):
        letter = 'è'
        ascii_letter = 'e'
        letter_translated = accents.remove_accents(letter)
    ...
    def test_sentence_one(self):
        ...
        sentence_translated = accents.remove_accents(sentence)
